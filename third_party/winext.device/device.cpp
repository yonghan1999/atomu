...
PyObject* DisplayDeviceInformation(IEnumMoniker *pEnum)
{
	...
	while (pEnum->Next(1, &pMoniker, NULL) == S_OK)
	{
		...
		if (SUCCEEDED(hr))
		{
			...
			wchar_t *pValue = (wchar_t *)var.bstrVal;//_com_util::ConvertBSTRToString(var.bstrVal);
			hr = PyList_Append(pyList, PyUnicode_FromWideChar(pValue, SysStringLen(var.bstrVal)));//Py_BuildValue("s", pValue));
			//delete[] pValue;  
			if (FAILED(hr)) {
...
static PyObject *
getVideoInputDeviceList(PyObject *self, PyObject *args)
{
...
static PyObject *
getAudioInputDeviceList(PyObject *self, PyObject *args)
{
	PyObject* pyList = NULL; 
...
{
    {"getVideoInputDeviceList", getVideoInputDeviceList, METH_VARARGS, NULL},
    {"getAudioInputDeviceList", getAudioInputDeviceList, METH_VARARGS, NULL},
    {NULL, NULL, 0, NULL}
};
